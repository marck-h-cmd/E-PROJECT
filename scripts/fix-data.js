...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var passwordHash, adminEmail, admin, periodoExistente, periodo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    adminEmail = 'admin@unitru.edu.pe';
                ...
                case 2:
                    admin = _a.sent();
                    console.log("\u2705 Usuario Admin configurado: ".concat(admin.email));
                    return [4 /*yield*/, prisma.periodoAcademico.findFirst({
                            where: { activo: true }
                        })];
                case 3:
                    periodoExistente = _a.sent();
                    if (!!periodoExistente) return [3 /*break*/, 5];
                    return [4 /*yield*/, prisma.periodoAcademico.create({
                            data: {
                                nombre: '2024-II (ACTIVO)',
                                fechaInicio: new Date('2024-09-01'),
                                fechaFin: new Date('2025-01-31'),
                                estado: client_1.EstadoPeriodo.ACTIVO,
                                activo: true,
                                configuraciones: {
                                    create: {
                ...
                case 4:
                    periodo = _a.sent();
                    console.log("\u2705 Per\u00EDodo activo creado: ".concat(periodo.nombre));
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, prisma.periodoAcademico.update({
                ...
                case 6:
                    _a.sent();
                    console.log("\u2705 Per\u00EDodo existente activado: ".concat(periodoExistente.nombre));
                    _a.label = 7;
                case 7:
