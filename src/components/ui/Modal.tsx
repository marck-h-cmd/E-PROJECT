...
type ModalOverlayElement = React.ElementRef<typeof DialogPrimitive.Overlay>;
type ModalOverlayProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay>;

const ModalOverlay = React.forwardRef<ModalOverlayElement, ModalOverlayProps>(
...
type ModalContentElement = React.ElementRef<typeof DialogPrimitive.Content>;
...
type ModalTitleElement = React.ElementRef<typeof DialogPrimitive.Title>;
...
type ModalDescriptionElement = React.ElementRef<typeof DialogPrimitive.Description>;
type ModalDescriptionProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>;

const ModalDescription = React.forwardRef<ModalDescriptionElement, ModalDescriptionProps>(
