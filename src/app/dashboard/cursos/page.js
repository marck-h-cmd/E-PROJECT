...
function CursosPage() {
    ...
    var _d = (0, usePaginatedQuery_1.usePaginatedQuery)('/api/cursos', listParams), data = _d.data, meta = _d.meta, loading = _d.loading, error = _d.error, page = _d.page, setPage = _d.setPage, refresh = _d.refresh;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_client_1.apiGet)("/api/cursos/".concat(row.id))];
                case 2:
                    res = _b.sent();
                    c = res.data;
                    if (!c)
                    ...
                    setForm({
                        ...
                        ciclo: c.ciclo,
                        planEstudios: (_a = c.planEstudios) !== null && _a !== void 0 ? _a : '',
                ...
                case 3:
                    e_1 = _b.sent();
                    sonner_1.toast.error(e_1 instanceof api_client_1.ApiClientError ? e_1.message : 'No se pudo cargar el curso');
                    return [3 /*break*/, 5];
                case 4:
                    setSaving(false);
                    return [7 /*endfinally*/];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_client_1.apiPut)("/api/cursos/".concat(editing.id), {
                ...
                case 2:
                    _a.sent();
                    sonner_1.toast.success('Curso actualizado');
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, (0, api_client_1.apiPost)('/api/cursos', {
                        codigo: formateadores_1.Formateadores.codigo(form.codigo),
                        nombre: form.nombre,
                        creditos: form.creditos,
                        horasTeoria: form.horasTeoria,
                ...
                case 4:
                    _a.sent();
                    sonner_1.toast.success('Curso creado');
                    _a.label = 5;
                case 5:
                    setDialogOpen(false);
                    resetForm();
    ...
    var handleDelete = function (row) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, api_client_1.apiDelete)("/api/cursos/".concat(row.id))];
                case 3:
                    _a.sent();
                    sonner_1.toast.success('Curso desactivado');
                    refresh();
                    return [3 /*break*/, 5];
                case 4:
                    e_3 = _a.sent();
    ...
    var columns = [
        ...
        { key: 'nombre', header: 'Nombre', cell: function (r) { return <span className="font-medium text-gray-900">{r.nombre}</span>; } },
        { key: 'ciclo', header: 'Ciclo', cell: function (r) { return formateadores_1.Formateadores.ciclo(r.ciclo); } },
        {
            key: 'creditos',
            header: 'Créditos',
            cell: function (r) { return formateadores_1.Formateadores.creditos(r.creditos); },
        },
        {
            key: 'activo',
            header: 'Activo',
        ...
        },
        {
            key: 'grupos',
            header: 'Grupos',
            cell: function (r) { return (<link_1.default href={"/dashboard/grupos?cursoId=".concat(r.id)} className="inline-flex items-center gap-1 text-sm font-medium text-unt-blue hover:underline">
    ...
    return (<div>
      <PageHeader_1.PageHeader title="Cursos" description="Catálogo de asignaturas y enlace a grupos." actions={<button_1.Button onClick={openCreate} className="bg-unt-blue hover:bg-unt-blue/90 text-white">
            <lucide_react_1.Plus className="h-4 w-4"/>
            Nuevo curso
          </button_1.Button>}/>

      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <SearchBar_1.SearchBar value={qInput} onChange={setQInput} placeholder="Buscar por código o nombre…" onSubmit={function () { return setSearch(qInput.trim()); }}/>
      ...
      <DataTable_1.DataTable columns={columns} data={data} loading={loading} keyExtractor={function (r) { return r.id; }} emptyTitle="No hay cursos"/>
      ...
      <dialog_1.Dialog open={dialogOpen} onOpenChange={function (o) { return !o && (setDialogOpen(false), resetForm()); }}>
        <dialog_1.DialogContent className="max-w-lg">
          <dialog_1.DialogHeader>
            <dialog_1.DialogTitle>{editing ? 'Editar curso' : 'Registrar curso'}</dialog_1.DialogTitle>
          </dialog_1.DialogHeader>
          <div className="grid gap-3 py-2 max-h-[70vh] overflow-y-auto">
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <label_1.Label htmlFor="ciclo">Ciclo (1–10)</label_1.Label>
                <input_1.Input id="ciclo" type="number" min={1} max={10} value={form.ciclo} onChange={function (e) { return setForm(function (f) { return (__assign(__assign({}, f), { ciclo: parseInt(e.target.value, 10) || 1 })); }); }}/>
              </div>
            </div>
            <div>
            ...
            <div>
              <label_1.Label htmlFor="creditos">Créditos</label_1.Label>
              <input_1.Input id="creditos" type="number" min={1} value={form.creditos} onChange={function (e) { return setForm(function (f) { return (__assign(__assign({}, f), { creditos: parseInt(e.target.value, 10) || 0 })); }); }}/>
            </div>
            <div className="grid grid-cols-3 gap-2">
              <div>
                <label_1.Label htmlFor="ht">Horas teoría</label_1.Label>
                <input_1.Input id="ht" type="number" min={0} value={form.horasTeoria} onChange={function (e) {
            return setForm(function (f) { return (__assign(__assign({}, f), { horasTeoria: parseInt(e.target.value, 10) || 0 })); });
        }}/>
              </div>
              <div>
                <label_1.Label htmlFor="hp">Horas práctica</label_1.Label>
                <input_1.Input id="hp" type="number" min={0} value={form.horasPractica} onChange={function (e) {
            return setForm(function (f) { return (__assign(__assign({}, f), { horasPractica: parseInt(e.target.value, 10) || 0 })); });
        }}/>
              </div>
              <div>
                <label_1.Label htmlFor="hl">Horas laboratorio</label_1.Label>
                <input_1.Input id="hl" type="number" min={0} value={form.horasLaboratorio} onChange={function (e) {
            return setForm(function (f) { return (__assign(__assign({}, f), { horasLaboratorio: parseInt(e.target.value, 10) || 0 })); });
        }}/>
              </div>
            </div>
            <div>
              <label_1.Label htmlFor="plan">Plan de estudios (opcional)</label_1.Label>
              <input_1.Input id="plan" value={form.planEstudios} onChange={function (e) { return setForm(function (f) { return (__assign(__assign({}, f), { planEstudios: e.target.value })); }); }}/>
            </div>
            {editing && (<div className="flex items-center gap-2">
                ...
                <label_1.Label htmlFor="activo">Curso activo</label_1.Label>
              </div>)}
          </div>
